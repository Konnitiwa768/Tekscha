...
def main():
    ...
    with sync_playwright() as p:
        ...
        # === STEP 1: ログインページ ===
        page.goto(
            "https://www.powerupstack.com/auth/login?redirect=/panel/instances/komugi7/files?path=resource_packs"   
            )
